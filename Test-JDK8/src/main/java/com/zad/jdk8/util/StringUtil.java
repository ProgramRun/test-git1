...
public final class StringUtil {
    ...
    public static CharSequence getDefaultIfNull(CharSequence cs, CharSequence defaultRes) {
        return cs == null ? defaultRes : cs;
    }

    public static CharSequence getDefaultIfEmpty(CharSequence cs, CharSequence defaultRes) {
        return isEmpty(cs) ? defaultRes : cs;
    }

    public static CharSequence getDefaultIfBlank(CharSequence cs, CharSequence defaultRes) {
        return isBlank(cs) ? defaultRes : cs;
    }
